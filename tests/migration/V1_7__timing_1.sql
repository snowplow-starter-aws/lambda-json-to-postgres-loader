...
CREATE TABLE atomic.com_snowplowanalytics_snowplow_timing_1 (
    ...
    CONSTRAINT timing_1__root_id_pk PRIMARY KEY(root_id),
...
CREATE INDEX timing_1__root_tstamp_idx ON atomic.com_snowplowanalytics_snowplow_timing_1 (root_tstamp);