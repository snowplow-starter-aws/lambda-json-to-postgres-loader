...
CREATE TABLE atomic.com_snowplowanalytics_snowplow_web_page_1 (
	...
	CONSTRAINT web_page_1__root_id_pk PRIMARY KEY(root_id),
...
CREATE INDEX web_page_1__root_tstamp_idx ON atomic.com_snowplowanalytics_snowplow_web_page_1 (root_tstamp);